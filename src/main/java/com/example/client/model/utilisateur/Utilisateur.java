...
public class Utilisateur {
    ...
    public boolean isLogin() {
        boolean response = this != null && ( (this.getNomUtilisateur() != null && !this.getNomUtilisateur().isEmpty()) || (this.getEmail() != null && !this.getEmail().isEmpty()) ) && this.getMotDePasse() != null && !this.getMotDePasse().isEmpty();
        return response;
    }
